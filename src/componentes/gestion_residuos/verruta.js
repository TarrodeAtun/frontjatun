...
export default class VerRuta extends Component {
    constructor(props) {
        super(props);
    ...
    enviaDatos = async e => {
        ...
        if (!campoVacio) {
            const res = await Axios.post('/api/gestion-residuos/rutas/modificar/', {
                id:id,
    ...
    render() {
        ...
        return (
            <div className="principal" id="component-perfil">
                <div>
                    <h2 className="verde"><button className="boton-vacio" onClick={this.volver}> <Bverderev /> </button><span>Control Logistico</span> / <strong>Detalle ruta</strong></h2>
