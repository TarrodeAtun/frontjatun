...
export default class CambiarPass extends Component {
    ...
    enviarDatos = async (e) => {
        ...
        const res = await Axios.post('/api/gestion-residuos/emergencias/residuos/crear/', formData, { headers: authHeader() })
            .then(respuesta => {
                ...
                <div>
                    ...
                    <div>
                        <div className="elemento">
                            <input type="date" className="input-generico w100" value="1" onChange={this.onChangeInput} name="fecha"></input>
                        </div>
                        <div className="elemento">
