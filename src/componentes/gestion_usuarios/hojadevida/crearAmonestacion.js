                ...
                customUI: ({ onClose }) => {
                    return (
                        <div className='custom-confirm'>
                            <p>Esta amonestación se cargará automáticamente al perfil <br /> del trabajador involucrado <strong>al presionar guardar.</strong></p>
                            <button className="boton-generico btazulalt" onClick={onClose}>Cancelar</button>
                            <button className="boton-generico btazul"
                                onClick={async () => {

                                    const res = await Axios.post('/api/users/worker/ficha/hojavida/crearAmonestacion', {
