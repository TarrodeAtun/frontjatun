...
export default class ListarTrabajadores extends Component {
    ...
    render() {
        ...
        return (
            <div className="principal menu-lista-dashboard" id="component-listar-trabajadores">
                <div>
                    <h2 className="amarillo"><Link to={`/personas/turnos/trabajador/${this.state.idUsuario}`}> <Bamarillorev /> </Link> Turnos <strong>/ Historial de Turnos</strong></h2>
                </div>
                ...
                <div className="listado">
                    <h3 className="amarillo">Turno en curso o Ultimo turno</h3>
                    <table>
                        <thead>
                            <th>Fecha / Jornada</th>
